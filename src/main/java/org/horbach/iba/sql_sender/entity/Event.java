...
public class Event {
	...
	public Event(int id, String title, String summary, LocalDateTime date, Location location, int price) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Event [id=" + id + ", title=" + title + ", summary=" + summary + ", date=" + date + ", location="
