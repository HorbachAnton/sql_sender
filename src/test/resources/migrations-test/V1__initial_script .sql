-- -----------------------------------------------------
-- Table `sql_sender`.`Request_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql_sender`.`Request_type` (
...
CREATE TABLE IF NOT EXISTS `sql_sender`.`Request` (
  ...
  CONSTRAINT `fk_Request_Request_type1`
    ...
    REFERENCES `sql_sender`.`Request_type` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
INSERT INTO `sql_sender`.`role` (`id`, `title`) VALUES ('1', 'USER');
INSERT INTO `sql_sender`.`role` (`id`, `title`) VALUES ('2', 'ADMIN');

-- -----------------------------------------------------
-- Filling the table(`sql_sender`.`Request_type`) with test data
-- -----------------------------------------------------
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('1', 'SELECT');
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('2', 'UPDATE');
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('3', 'INSERT');
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('4', 'DELETE');
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('5', 'CREATE');
INSERT INTO `sql_sender`.`request_type` (`id`, `title`) VALUES ('6', 'DROP');

-- -----------------------------------------------------
-- Filling the table(`sql_sender`.`User`) with test data
-- -----------------------------------------------------
INSERT INTO `sql_sender`.`user` (`id`, `username`, `password`, `enabled`, `Role_id`) VALUES ('1', 'admin', 'admin', '1', '2');
...
-- -----------------------------------------------------
INSERT INTO `sql_sender`.`request` (`id`, `text`, `Request_type_id`, `execute_date`, `User_id`, `Request_result_id`) VALUES ('1', 'SELECT * FROM sql_sender.request;', '1', '2020-10-12 14:32:44', '1', '1');

-- -----------------------------------------------------
-- Filling the table(`sql_sender`.`Log_record`) with test data
-- -----------------------------------------------------
