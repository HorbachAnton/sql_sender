...
class AuthorizationControllerTest {
	...
	public static final String AUTHORIZATION_CONTROLLER_BEAN_NAME = "authorizationController";
	...
	public void verifyConfiguration() {
		...
		assertThat(wac.getBean(AUTHORIZATION_CONTROLLER_BEAN_NAME), is(notNullValue()));
	}

	@Test
	@WithAnonymousUser
	public void testSuccessGetPage() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/authorization/")).andDo(MockMvcResultHandlers.print())
